...
struct GlobalDynamicResolutionSettings_t2BF29E3CFADCD55F6AC2D35D728817B79264A9A0 
{
	...
	bool ___useMipBias;
	bool ___enableDLSS;
	uint32_t ___DLSSPerfQualitySetting;
	int32_t ___DLSSInjectionPoint;
	bool ___DLSSUseOptimalSettings;
	float ___DLSSSharpness;
	bool ___fsrOverrideSharpness;
	float ___fsrSharpness;
	float ___maxPercentage;
	float ___minPercentage;
	uint8_t ___dynResType;
	uint8_t ___upsampleFilter;
	bool ___forceResolution;
	float ___forcedPercentage;
	float ___lowResTransparencyMinimumThreshold;
	float ___rayTracingHalfResThreshold;
	float ___lowResSSGIMinimumThreshold;
	float ___lowResVolumetricCloudsMinimumThreshold;
};
struct GlobalDynamicResolutionSettings_t2BF29E3CFADCD55F6AC2D35D728817B79264A9A0_marshaled_pinvoke
{
	int32_t ___enabled;
	int32_t ___useMipBias;
	int32_t ___enableDLSS;
	uint32_t ___DLSSPerfQualitySetting;
	int32_t ___DLSSInjectionPoint;
	int32_t ___DLSSUseOptimalSettings;
	float ___DLSSSharpness;
...
struct DynamicResolutionHandler_t4D0ED3CF6D7BE856065759A87B44AC0FF5D8FAEE  : public RuntimeObject
{
	...
	float ___m_MinScreenFraction;
	float ___m_MaxScreenFraction;
	float ___m_CurrentFraction;
	bool ___m_ForcingRes;
	bool ___m_CurrentCameraRequest;
	float ___m_PrevFraction;
	bool ___m_ForceSoftwareFallback;
	bool ___m_RunUpscalerFilterOnFullResolution;
	float ___m_PrevHWScaleWidth;
	float ___m_PrevHWScaleHeight;
	Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A ___m_LastScaledSize;
	Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A ___cachedOriginalSize;
	uint8_t ___U3CfilterU3Ek__BackingField;
	Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A ___U3CfinalViewportU3Ek__BackingField;
	uint8_t ___type;
	GlobalDynamicResolutionSettings_t2BF29E3CFADCD55F6AC2D35D728817B79264A9A0 ___m_CachedSettings;
	WeakReference_tD4B0518CE911FFD9FAAB3FCD492644A354312D8E* ___m_OwnerCameraWeakRef;
	int32_t ___m_UpsamplerSchedule;
};
...
{
	int32_t ___s_ActiveScalerSlot;
	ScalerContainerU5BU5D_tC77571377136111C49364FC610EEABE164F62577* ___s_ScalerContainers;
	Dictionary_2_tD63479E1341B4C7016EC65CE665BEDD2FD651720* ___s_CameraUpscaleFilters;
	Dictionary_2_t2A39BD4C1E857041785410552D256CB3E9342B4C* ___s_CameraInstances;
	DynamicResolutionHandler_t4D0ED3CF6D7BE856065759A87B44AC0FF5D8FAEE* ___s_DefaultInstance;
	int32_t ___s_ActiveCameraId;
	DynamicResolutionHandler_t4D0ED3CF6D7BE856065759A87B44AC0FF5D8FAEE* ___s_ActiveInstance;
	bool ___s_ActiveInstanceDirty;
	float ___s_GlobalHwFraction;
	bool ___s_GlobalHwUpresActive;
};
#ifdef __clang__
...
struct DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F_ComCallableWrapper IL2CPP_FINAL : il2cpp::vm::CachedCCWBase<DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F_ComCallableWrapper>, IBindableIterable_t257967EF5CDA5DFD63615802571892212B01796C, IBindableVector_tAE2FC72291BFE4E2FE6FCE88670236BBA429833A
{
	inline DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F_ComCallableWrapper(RuntimeObject* obj) : il2cpp::vm::CachedCCWBase<DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F_ComCallableWrapper>(obj) {}
...
IL2CPP_EXTERN_C Il2CppIUnknown* CreateComCallableWrapperFor_DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F(RuntimeObject* obj)
{
	void* memory = il2cpp::utils::Memory::Malloc(sizeof(DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F_ComCallableWrapper));
	if (memory == NULL)
	{
		il2cpp_codegen_raise_out_of_memory_exception();
	}

	return static_cast<Il2CppIManagedObjectHolder*>(new(memory) DoublePointU5BU5D_t837A74651F1896745A1BDBF53C885A598C17082F_ComCallableWrapper(obj));
}
